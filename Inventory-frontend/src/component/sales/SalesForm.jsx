...
const SalesForm = () => {
 ...
 await axios.post("http://localhost:3800/sales",formData)
      ...
      {isLoading ? (
        ...
        {paymentOpen ? (
            <div className="modal-ka-baap" >
              <div className="add-item-modal-in" style={{ width: "400px",height:"150px",textAlign:"center"}}>
               <h3>Confirm Your Payment</h3>
                <div className="add-item-modal-bottom" style={{right:"50%"}}>
                  <div className="payment-pop-buttons">
                    <button
                      className="next-button-in"
                      style={{padding:"10px 30px",height:"40px",width:"120px",cursor:"pointer"}}
                      onClick={(e) => {
                        paymentHandler(e)
                      }}
                    ...
                    <button
                      ...
                      style={{padding:"10px 30px",height:"40px",width:"120px",border:"none",cursor:"pointer"}}
                    >
                      Cancel
                    </button>
                  </div>
